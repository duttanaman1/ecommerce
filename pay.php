...
if ($_POST['submit'] != null) {
    ...
    mysqli_query($con, "UPDATE orders set custname='$custname', custphone='$custphone', pincode='$pincode', custaddr='$custaddr', status='paid' where custname='user' and status ='unpaid' ");
    $custpay = $_POST['total'];
    $msg = '';
    $success = true;
}
                ...
                <div class="col">
                    <div class="card-checkout" id="card-checkout">
                        ...
                        <div class="card-confirm">
                            ...
                            <input type="button" value="submit" id="submit-button" class="button-confirm" name="success">
                    ...
                    <div id="success" class="success hidden">
                        ...
                        <p>
                            <?php if ($success) {
                            ?>
                                <button class="btn btn-success" onclick="window.open('shop.php','_self')">Confirm</button>
                            <?php
                            }
                            ?> </p> <?php
